...
public class TesteFuncionario {
	...
	public static void main(String[] args) {
		...
		System.out.println("O Salário Bruto é: " + func.salarioBruto);
		System.out.println("O Salário Líquido é: " + func.calcularNovoSalario());
		...
		System.out.println("O Nome do funcionário é: " + func.nome);
		System.out.println("O Salário Bruto é: " + func.salarioBruto);
		System.out.println("O Novo Salário é: " + func.calcularAumentoSalario(porc));
	}
}
